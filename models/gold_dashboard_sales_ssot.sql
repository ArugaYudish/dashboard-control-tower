...
horizontal_registry AS (
    ...
    SELECT 
        ...
        -- 📦 DATA ORIGINAL CURRENT YEAR (STM s/d Week Aktif, Masa Depan dipaksa 0)
        ...
        -- 🔮 DATA PROYEKSI MASA DEPAN (Murni diisi SALFO hanya jika week > cur_week!)
        ...
        -- 🛑 DATA CLOSING BULAN LALU (Tarik secara horizontal berdasarkan penutupan periode sebelumnya)
        -- Jika period = 1 (Week awal tahun), targetkan ke Period 12 Tahun Lalu (ly_lm)
    ...
    -- Join 2: Menarik data Bulan Lalu di tahun yang SAMA (Period 2 s/d 12)
    ...
    -- Join 3: Menarik data Bulan Lalu jika sedang berada di Period 1 (Targetkan ke Period 12 Tahun Lalu)
