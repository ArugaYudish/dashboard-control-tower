-- Metabase SQL Query: NPL Breakdown Weekly Omset by Group Salesforce 1 (gsalesforce1)
-- Source: bift.gold_npl_by_gsalesforce1_dev (or bift.gold_npl_by_gsalesforce1 in production)
-- Output: SD | NSM | GRSM | RSM | SS | Distributor | Break By (gsalesforce1_id - gsalesforce1_nm) | week | omset
...
FROM outlet_orders
GROUP BY ss_id, distributor_id, gsalesforce1_id, gsalesforce1_nm, week
ORDER BY ss_id, distributor_id, gsalesforce1_id, week;
