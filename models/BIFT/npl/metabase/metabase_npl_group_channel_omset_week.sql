-- Metabase SQL Query: NPL Breakdown Weekly Omset by Group Channel
-- Source: bift.gold_npl_by_group_channel_dev (or bift.gold_npl_by_group_channel in production)
-- Output: SD | NSM | GRSM | RSM | SS | Distributor | Break By (group_channel_id - group_channel_nm) | week | omset
...
FROM outlet_orders
GROUP BY ss_id, distributor_id, group_channel_id, group_channel_nm, week
ORDER BY ss_id, distributor_id, group_channel_id, week;
