-- Metabase SQL Query: NPL Breakdown Summary by Classification
-- Source: bift.gold_npl_by_classification_dev (or bift.gold_npl_by_classification in production)
-- Output: SD | NSM | GRSM | RSM | SS | Distributor | Break By (classification_id - classification_nm) | cb_cover | oa | %oa | total_dropsize | non_repeat | t2 | t3 | t4 | t5 | t6 | percent_repeat
...
FROM outlet_orders
GROUP BY ss_id, distributor_id, classification_id, classification_nm
ORDER BY ss_id, distributor_id, classification_id;
